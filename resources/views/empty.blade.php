...
<html lang="en" dir="ltr" data-nav-layout="vertical" class="light" data-header-styles="light" data-menu-styles="dark">
    ...
    <head>
        ...
        <!-- APP SCSS -->
        <link rel="preload" as="style" href="build/assets/app-6b44ca98.css" /><link rel="stylesheet" href="build/assets/app-6b44ca98.css" />
	...
	<body>
        ...
        <div id="hs-overlay-switcher" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right" tabindex="-1">
                ...
                <div class="ti-offcanvas-footer sm:flex justify-between">
                    <a href="https://themeforest.net/item/ynex-laravel-tailwind-admin-dashboard-template/49617469" target="_blank" class="w-full ti-btn ti-btn-primary-full m-1">Buy Now</a>
                ...
                <nav class="main-header !h-[3.75rem]" aria-label="Global">
                    ...
                    <div class="header-content-right">
                        ...
                        <button id="dropdown-flag" type="button"
                            ...
                            <img src="build/assets/images/flags/us_flag.jpg" alt="flag-img" class="h-[1.25rem] w-[1.25rem] rounded-full">
                        </button>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <div class="">
                                <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                    <img src="build/assets/images/apps/microsoft-powerpoint.png" alt="miscrosoft"
                                ...
                                <div class="">
                                <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                    <img src="build/assets/images/apps/microsoft-word.png" alt="miscrodoftword"
                                    class="leading-none
                        ...
                        <button id="dropdown-profile" type="button"
                            ...
                            <img class="inline-block rounded-full " src="build/assets/images/faces/9.jpg"  width="32" height="32" alt="Image Description">
                        </button>
                        ...
                        <div
                            ...
                            <li><a class="w-full ti-dropdown-item !text-[0.8125rem] !p-[0.65rem] !gap-x-0 !inline-flex" href="signin-cover.html"><i
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Create
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="createpassword-basic.html" class="side-menu__item">Basic</a></li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Reset Password<i
                                                class="fe fe-chevron-right side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="resetpassword-basic.html" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="resetpassword-cover.html" class="side-menu__item">Cover</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Two Step
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="twostep-verification-basic.html" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="twostep-verification-cover.html" class="side-menu__item">Cover</a>
                                            </li>
                                        </ul>
                                    </li>
        ...
        <!-- SWITCH JS -->
        <link rel="modulepreload" href="build/assets/switch-8d0a5268.js" /><script type="module" src="build/assets/switch-8d0a5268.js"></script>
        ...
        <!-- APP JS -->
		<link rel="modulepreload" href="build/assets/app-cff42aa7.js" /><script type="module" src="build/assets/app-cff42aa7.js"></script>

        <!-- CUSTOM-SWITCHER JS -->
        <link rel="modulepreload" href="build/assets/custom-switcher-508a7845.js" /><script type="module" src="build/assets/custom-switcher-508a7845.js"></script>

              ...
              <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="box-body">
                          <div class="flex items-top justify-between">
                            <div>
                              ...
                              >
                                <i
                                  class="ti ti-users text-[1rem] text-white"
                                ></i>
                              </span>
                            </div>
                        ...
                        <div class="box-body">
                          <div class="flex items-top justify-between">
                            <div>
                              ...
                              >
                                <i
                                  class="ti ti-wallet text-[1rem] text-white"
                                ></i>
                              </span>
                            </div>
                            <div class="flex-grow ms-4">
                ...
                <div class="xxl:col-span-12 xl:col-span-12 col-span-12">
                  <div class="box custom-card">
                    <div class="box-header justify-between">
                      <div class="box-title">Deals Statistics</div>
                        ...
                        >
                          <thead>
                            ...
                            >
                              ...
                              <th
                                scope="col"
                                class="!text-start !text-[0.85rem] min-w-[200px]"
                              >
                                Sales Rep
                              </th>
                              <th
                                scope="col"
                                class="!text-start !text-[0.85rem]"
                              >
                                Category
                              </th>
                              <th
                              ...
                              <td>
                                ...
                                >
                                  <a
                                    aria-label="anchor"
                                    href="javascript:void(0);"
                                    class="ti-btn ti-btn-icon ti-btn-wave !m-0 !h-[1.75rem] !gap-0 !w-[1.75rem] text-[0.8rem] bg-success/10 text-success hover:bg-success hover:text-white hover:border-success"
                                    ><i class="ri-download-2-line"></i
                                  ></a>
                                  <a
                                    aria-label="anchor"
                                    href="javascript:void(0);"
                                    class="ti-btn ti-btn-icon ti-btn-wave !m-0 !h-[1.75rem] !gap-0 !w-[1.75rem] text-[0.8rem] bg-primary/10 text-primary hover:bg-primary hover:text-white hover:border-primary"
                                    ><i class="ri-edit-line"></i
                                  ></a>
                                </div>
                              </td>
                ...
                <div class="xxl:col-span-12 xl:col-span-12 col-span-12">
                  <div class="box">
                    ...
                    <div class="box-body overflow-hidden">
                      <div
                        class="leads-source-chart flex items-center justify-center"
                      >
                        <canvas
                          id="leads-source"
                  ...
                  <div class="box">
                    ...
                    <div class="box-body">
                      <div class="flex items-center mb-[0.8rem]">
                        ...
                        <div class="ms-2">
                          <span
                            class="py-[0.18rem] px-[0.45rem] rounded-sm text-success !font-medium !text-[0.75em] bg-success/10"
                            >1.02<i
                      ...
                      <div
                        class="flex w-full h-[0.3125rem] mb-6 rounded-full overflow-hidden"
                      >
                        <div
                      ...
                      <ul class="list-none mb-0 pt-2 crm-deals-status">
                        <li class="primary">
                          <div
                            class="flex items-center text-[0.813rem] justify-between"
                          >
                        ...
                        <ul class="list-none mb-0 crm-recent-activity">
                          <li class="crm-recent-activity-content">
                            <div class="flex items-start">
                              ...
                              <div
                                class="crm-timeline-content text-defaultsize"
                              >
                          ...
                          <li
                            class="crm-recent-activity-content text-defaultsize"
                          >
                            <div class="flex items-start">
                              <div class="me-4">
                                <span
                              ...
                              <div class="crm-timeline-content">
                                <span
                                  ...
                                  <span
                                    ...
                                    ><i
                                      class="ri-add-fill text-purple text-[0.75rem]"
                                    ></i></span
                                ></span>
                              </div>
                              <div class="flex-grow text-end">
                            ...
                            <div class="flex items-start">
                              ...
                              <div class="crm-timeline-content">
                                <span
                                  >New member
                                  <span
                                    class="py-[0.2rem] px-[0.45rem] font-semibold rounded-sm text-pink text-[0.75em] bg-pink/10"
                            ...
                            <div class="flex items-start">
                              ...
                              <div class="crm-timeline-content">
                                <span
                                  ...
                                  <i
                                    class="ri-checkbox-circle-line text-success text-[1rem] align-middle"
                                  ></i
                                ></span>
                              </div>
                              <div class="flex-grow text-end">
